...
const std::string USAGE_TYPE_shannon = "shannon";
const std::string USAGE_TYPE_shannon_MEMTABLE = "shannon.memtable";
//const std::string USAGE_TYPE_shannon_BLOCK_CACHE = "shannon.block_cache";
const std::string USAGE_TYPE_shannon_TABLE_READER = "shannon.table_reader";
