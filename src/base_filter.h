...
class BaseMetaFilter : public shannon::CompactionFilter {
  public:
    ...
    virtual const char* Name() const override { return "BaseMetaFilter"; }
};

class BaseMetaFilterFactory : public shannon::CompactionFilterFactory {
  public:
    ...
    virtual std::unique_ptr<shannon::CompactionFilter> CreateCompactionFilter(
      ...
      return std::unique_ptr<shannon::CompactionFilter>(new BaseMetaFilter());
    }
...
class BaseDataFilter : public shannon::CompactionFilter {
  public:
    BaseDataFilter(shannon::DB* db,
                   std::vector<shannon::ColumnFamilyHandle*>* cf_handles_ptr) :
      db_(db),
    ...
    virtual const char* Name() const override { return "BaseDataFilter"; }
...
class BaseDataFilterFactory : public shannon::CompactionFilterFactory {
  public:
    BaseDataFilterFactory(shannon::DB** db_ptr,
